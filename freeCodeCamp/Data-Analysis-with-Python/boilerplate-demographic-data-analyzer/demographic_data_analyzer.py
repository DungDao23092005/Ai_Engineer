...
def calculate_demographic_data(print_data=True):
    ...
    # 4. Percentage of people with advanced education who make >50K
    ...
    # 5. Percentage of people without advanced education who make >50K
    ...
    country_rich_counts = df[df["salary"] == ">50K"].groupby("native-country")["salary"].count()

    country_rich_percentage = (country_rich_counts / country_salary_counts) * 100
